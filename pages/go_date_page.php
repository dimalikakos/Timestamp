...
if ($_SESSION['account_type'] == 'ad' || $_SESSION['account_type'] == 'se') {
    ...
    <head>
        <meta charset="utf-8"/>
        <title> View Student Work Logs | Timestamp </title>
    ...
    <div class="page-container">
        ...
        <div class="page-content-wrapper">
            ...
            <div class="page-content">
                ...
                <!-- END PAGE BAR -->
                <!-- BEGIN PAGE TITLE-->
                <h3 class="page-title"> Select Date Page</h3>
                <!-- END PAGE TITLE-->
                <!-- END PAGE HEADER-->
                ...
                <div class="portlet box blue">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-calendar"></i>Select Date Page
                        </div>
                        <div class="tools">
                            <a href="javascript:;" class="in collapse"> </a>
