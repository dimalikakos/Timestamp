...
if ($_SESSION['account_type'] == 'ad' || $_SESSION['account_type'] == 'se' || $_SESSION['account_type'] == 'sa') {
    ...
    <head>
        <meta charset="utf-8"/>
        <title>Empty End Time Work Logs | Timestamp </title>
            ...
            <div class="page-content">
                ...
                <div class="page-bar">
                    <ul class="page-breadcrumb">
                        ...
                        <li>
                            <span>Empty End Time Work Logs</span>
                        </li>
                    </ul>
                ...
                <!-- END PAGE BAR -->
                <!-- BEGIN PAGE TITLE-->
                <h3 class="page-title"> <span>Work Logs With Empty End Times</span></h3>
                <!-- END PAGE TITLE-->
                <!-- END PAGE HEADER-->
                ...
                <div class="portlet box blue-hoki">
                    <div class="portlet-title">
                        <div class="caption">
                            <i class="fa fa-calendar"></i>Empty Work Logs
                        </div>
                        <div class="tools"></div>
                    </div>
                    <div class="portlet-body">
                        <table class="table table-striped table-bordered table-hover" id="sample_2">
                            ...
                            foreach ($logs as $log) {
                                ...
                                echo '<td> #' . $log['id'] . '</td>';
                                echo '<td>' . $log['student_id'] . '</td>';
                                $student_name = get_student_info($log['student_id']);
                                echo '<td>' . $student_name[0]['first_name'] ." ". $student_name[0]['last_name']. '</td>';
                                if ($_SESSION['account_type'] != 'sa'){
                                    $link = 'href="/pages/single.php?date_page='.$log['date_worked'].'"';
                                }else{
                                    $link = 'style = "text-decoration: none; color: #34495e; "';
                                }
                                echo '<td> <a '.$link.'>' .$log['date_worked']. '</a></td>';
                                echo '<td style="display: none"></td>';
                                echo '<td style="display: none"></td>';
                                echo '<td style="display: none"></td>';
                                echo '</tr>';
